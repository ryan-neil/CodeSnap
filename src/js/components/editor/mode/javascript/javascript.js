...
(function(mod) {
	...
	CodeMirror.defineMode('javascript', function(
		...
		var wordRE =
			parserConfig.wordCharacters || /[\w$\xa1-\uffff]/;
		...
		function maybeoperatorNoComma(type, value, noComma) {
			var me =
				noComma == false
					...
					: maybeoperatorNoComma;
			var expr =
				noComma == false ? expression : expressionNoComma;
			if (type == '=>')
				return cont(
					pushcontext,
